...
cl_optimization_hash (struct cl_optimization const *ptr ATTRIBUTE_UNUSED)
{
  ...
  hstate.add_wide_int (ptr->x_flag_keep_gc_roots_live);
  hstate.add_wide_int (ptr->x_flag_lifetime_dse);
  hstate.add_wide_int (ptr->x_flag_live_range_shrinkage);
  hstate.add_wide_int (ptr->x_flag_loop_nest_optimize);
  ...
  hstate.add_wide_int (ptr->x_flag_plt);
  ...
  hstate.add_wide_int (ptr->x_flag_reorder_blocks_algorithm);
  ...
  hstate.add_wide_int (ptr->x_flag_split_paths);
  hstate.add_wide_int (ptr->x_flag_split_wide_types);
  hstate.add_wide_int (ptr->x_flag_ssa_backprop);
  ...
  hstate.add_wide_int (ptr->x_flag_tree_coalesce_vars);
  ...
  hstate.add_wide_int (ptr->x_flag_unconstrained_commons);
